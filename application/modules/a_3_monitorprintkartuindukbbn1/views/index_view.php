  ...
  <div class="col-md-3">
    <div class="box box-solid bg-green-gradient">
      ...
      <div class="box-footer text-black">
        <div class="row">
          <div class="col-md-4">
            <button class="btn btn-success"><i class="fa-print"> </i> Cetak</button>
          </div>
          <div class="col-md-8">
            <button class="btn btn-success pull-right"><i class="fa-print"> </i> Cetak Pilih</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-md-3">
    <div class="box box-solid bg-yellow-gradient">
      ...
      <div class="box-footer text-black">
        <div class="row">
          <div class="col-md-4">
            <button class="btn btn-warning"><i class="fa-print"> </i> Cetak</button>
          </div>
          <div class="col-md-8">
            <button class="btn btn-warning pull-right"><i class="fa-print"> </i> Cetak Pilih</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-md-3">
    <div class="box box-solid bg-red-gradient">
      ...
      <div class="box-footer text-black">
        <div class="row">
          <div class="col-md-4">
            <button class="btn btn-danger"><i class="fa-print"> </i> Cetak</button>
          </div>
          <div class="col-md-8">
            <button class="btn btn-danger pull-right"><i class="fa-print"> </i> Cetak Pilih</button>
          </div>
        </div>
      </div>
    </div>
