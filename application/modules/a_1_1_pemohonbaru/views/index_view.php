  ...
  <div class="col-md-6"><br>
    <div class="table-responsive">
      <table class="table table-bordered">
        ...
        <tr>
          <td width="25%" height="40px" valign="top"><label class="control-label">Nama</label></td>
          <td colspan="3" width="100%" height="40px" valign="top"><input type="text" id="idNamaPBB1Pemohon" name="" class="form-control col-md-7 col-xs-12 input-style" placeholder="Massukan Data"></td>
          </tr>
          <tr>
