      ...
      function chkEvent(e) {
        ...
        if(keycode==13){
          ...
          if(ElementHtml.attr("id")==temp){
            temp=jsAarray[4];
            console.log (temp);
            $("#NNoRangka_ModalkbPbbAdd").jqxInput('focus');
          }else{
sundul1(ElementHtml.attr("id"));

          }
          alert("1: " + ElementHtml.attr("name"));
          temp=jsAarray[4];
    ...
    function sundul1(str){
      if(str=="idPbb1PemohonNamaInput"){
        alert('kursor ke baweh');
      }
      // id($('#'+str)==
