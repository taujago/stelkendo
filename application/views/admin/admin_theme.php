			...
			<div class="navbar-custom-menu">
			  <ul class="nav navbar-nav">
				  ...
				  <li class="dropdown user user-menu">
				  	<a href="#" class="dropdown-toggle" data-toggle = "dropdown"><i class="glyphicon glyphicon-user"></i><span class="hidden-xs"></span></a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="<?php echo site_url('pendaftaran'); ?>">
                <i class="fa fa-dashboard"></i> <span>Pendaftaran BBN 1</span></i>
              </a>
            </li>
            <li class="treeview">
              <a href="<?php echo site_url('pendaftaran'); ?>">
                <i class="fa fa-dashboard"></i> <span>Regitrasi</span></i>
              </a>
            </li>
          </ul>
        </section>
